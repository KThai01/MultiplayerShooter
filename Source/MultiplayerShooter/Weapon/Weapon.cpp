...
void AWeapon::BeginPlay()
{
	...
	if (HasAuthority()) // only happens on the server
	{
...
void AWeapon::SetWeaponState(EWeaponState State)
{
	...
	case EWeaponState::EWS_Equipped:
		...
		AreaSphere->SetCollisionEnabled(ECollisionEnabled::NoCollision);
		// Disables physics on weapons when equipped
	...
	case EWeaponState::EWS_Dropped:
		...
		// Enables Physics on dropped weapons
...
{
	Ammo = FMath::Clamp(Ammo - 1, 0, MagCapacity); // Ammo is never less than 0 or greater than MagCapacity
	SetHUDAmmo();
}
