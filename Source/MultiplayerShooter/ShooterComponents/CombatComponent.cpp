...
void UCombatComponent::EquipWeapon(AWeapon* WeaponToEquip)
{
	...
	const USkeletalMeshSocket* HandSocket = Character->GetMesh()->GetSocketByName(FName("RightHandSocket")); // Store the socket in a variable
	if (HandSocket)
	{
		HandSocket->AttachActor(EquippedWeapon, Character->GetMesh()); // attach the actor to the socket
	}
...
void UCombatComponent::FinishRelading()
{
	if (Character == nullptr) return;
	if (Character->HasAuthority())
	{
